...
│   ├── product-angle.png
│   └── ...
├── [brand-dna.md](http://brand-dna.md)             # Generated by Phase 1
├── prompts.json             # Generated by Phase 2
├── generate_[ads.py](http://ads.py)          # Image generation script (Phase 3)
...
Save output as: ~/brands/{brand-name}/[brand-dna.md](http://brand-dna.md)
...
Reference file for templates: See references/[template-prompts.md](http://template-prompts.md)
...
python generate_[ads.py](http://ads.py)

Or generate specific templates only:

python generate_[ads.py](http://ads.py) --templates 1,7,13,15

### Script Behavior

The generate_[ads.py](http://ads.py) script (see references/generate_[ads.py](http://ads.py)):
